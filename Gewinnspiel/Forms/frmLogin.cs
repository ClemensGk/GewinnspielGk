...
namespace Gewinnspiel.Forms
{
    public partial class frmLogin : Form
    {
        ...
        internal frmTeilnehmerListe frmTeilListe;
        #endregion
        ...
        internal void showImages()
        {
            ...
            foreach (Spiel s in gewinnspielListe)
            {
                try
                {
            ...
            frmTeiln.lvAktiveGewinnspiele.SmallImageList = bilderListe;
            frmAd.lvGewinnspiele.SmallImageList = bilderListe;
        }
        #endregion
